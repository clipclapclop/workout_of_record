...
final kMovementSeeds = <MovementSeedEntry>[
  ...
  _ca('Cable Flye (Bent Over)', MuscleGroup.chest),
  _ca('Cable Flye (High)', MuscleGroup.chest),
  _ca('Cable Flye (Seated)', MuscleGroup.chest),
  _ca('Cable Flye (Underhand)', MuscleGroup.chest),
  ...
  _ca('Cable Overhead Triceps Extension', MuscleGroup.triceps),
  _ca('Cable Overhead Triceps Extension (Rope)', MuscleGroup.triceps),
  ...
  _ca('Cable Triceps Pushdown (Bar)', MuscleGroup.triceps),
  _ca('Cable Triceps Pushdown (Rope)', MuscleGroup.triceps),
  ...
  _db('Dumbbell Curl (Incline)', MuscleGroup.biceps),
  ...
  _ez('EZ Bar Overhead Triceps Extension', MuscleGroup.triceps),
  _ez('EZ Bar Overhead Triceps Extension (Seated)', MuscleGroup.triceps),
  ...
  _mc('Machine Triceps Extension', MuscleGroup.triceps),
  _mc('Machine Triceps Pushdown', MuscleGroup.triceps),
